  ...
  if (!$("#notification-container").length) {
    var tpl = '<div id="notification-container" style="display: none">\
                 <div id="template-pic">\
                   ...
                   <h2 class="icon_success"><span class="style_title">Added to cart successfully</span></h2>\
                   <div class="style_text">\
                     <span style="display:none">#{thumb}</span>\
                     <h3>#{text}</h3>\
                   </div>\
                 </div>\
                 <div id="template-no-pic">\
                   <a class="  ui-notify-close ui-notify-cross  "  href="#">x</a>\
                   <h2 class="icon_success"><span class="style_title">Added Successfully</span></h2>\
                   <div class="style_text">\
                     <h3>#{text}</h3>\
                   </div>\
                 </div>\
