	...
	<div class="left">
		<?php if ($product['thumb']) { ?>
			...
			<div class="flybar">
				...
				<?php if($theme_options->get( 'category_page_display_add_to_compare' ) == 1) { ?>
					<div class="compare">			
				...
				<?php if($theme_options->get( 'category_page_display_quickview' ) == 1) { ?>
					<div class="quickview">
						<a rel="<?php echo $product['href']; ?>" title="<?php echo $product['name']; ?>" class="fa fa-search"></a>
					</div>
				<?php } ?>
				
				<?php if($theme_options->get( 'category_page_display_add_to_wishlist' ) == 1) { ?>
					<div class="wishlist">
