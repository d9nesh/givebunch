<div class="product-list"<?php if($theme_options->get('default_list_grid') == '1') { echo ' style="display:none;"'; } ?>>
  	...
  	<?php foreach ($products as $product) { ?>
  		<?php $list_class = "list_odd"; ?>
  		<?php if($count % 2 == 0): ?>
  			<?php $list_class = "list_even"; ?>		
  		<?php endif; ?>
  		<?php $count++; ?>
  	<!-- Product -->
  	<div>
  		<div class="row">
			<?php if($product['special'] && $theme_options->get( 'display_text_sale' ) != '0') { ?>
  					...
  					<?php } ?>
  				<?php } ?>
  			<div class="image col-sm-6 <?php echo $list_class; ?>">
  			...
  			<div class="name-desc col-sm-5">
  				...
  				<div class='list-description-box'>
					...
					<?php if($theme_options->get( 'category_page_display_add_to_cart' ) != '0') { ?>
						<div class="add-to-cart"><a onclick="cart.add('<?php echo $product['product_id']; ?>');" class="button"><span><?php echo 'view more >>' ?></span></a></div>
						
						<!-- <div class="add-to-cart"><a onclick="cart.buy('<?php echo $product['product_id']; ?>');" class="button"><span><?php echo 'Buy Now';?></span></a></div> -->
					<?php } ?>
  				</div>
  			</div>
