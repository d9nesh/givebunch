	...
	<div class="left">
		<?php if ($product['thumb']) { ?>
			...
			<div class="flybar hide">
				...
				<?php if($theme_options->get( 'display_add_to_compare' ) == 1) { ?>
					<div class="compare">			
				...
				<?php if($theme_options->get( 'display_add_to_wishlist' ) == 1) { ?>
					<div class="wishlist">
				...
				<?php if($theme_options->get( 'display_add_to_cart' ) == 1) { ?>
					<div class="addtocart hide">
					<a href="<?php echo $product['href']; ?>" class="button"><span><?php if($theme_options->get( 'add_to_cart_text', $config->get( 'config_language_id' ) ) != '') { echo $theme_options->get( 'add_to_cart_text', $config->get( 'config_language_id' ) ); } else { echo 'view more>>'; } ?></span></a>
					</div>
				<?php } ?>
			</div>
			<?php } ?>
