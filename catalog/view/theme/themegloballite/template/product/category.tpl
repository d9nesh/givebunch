...
<?php include('catalog/view/theme/'.$config->get('config_template').'/template/themeglobal/themeglobal_top.tpl'); ?>
  ...
  <?php if ($categories && $theme_options->get('refine_search_style') != '2') { ?>
	...
	<?php if ($products) { ?>
  <!-- Filter -->
  <div class="product-filter bunch-list-view clearfix">
  	<h2> The Bunch Collection </h2>
  	<div class="bunch-tagline"> Handcrafted, curated and design for any occasion </div>
  	<!-- <div class="options">
