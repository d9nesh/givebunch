  	...
  	<div class="row">
  		<div class="col-sm-<?php if($theme_options->get( 'custom_block', 'product_page', $config->get( 'config_language_id' ), 'status' ) == 1) { echo 9; } else { echo 12; } ?>">
  			<div class="row" id="quickview_product">
			    ...
			    <?php } ?>
			  <?php $image_grid = 6; $product_center_grid = 5;    ?>
			    ...
			    <div class="col-sm-<?php echo $product_center_grid; ?> product-center clearfix" style="padding:5em 2em 2em 2em">
			        ...
			        <div class="add-to-cart clearfix">
			          ...
			          &nbsp;
							...
							<div class="cart-holder">	
								...
								<input type="button" value="<?php echo 'Buy Now' ?>" id="button-cart-buy" rel="<?php echo $product_id; ?>" class="button button-cart-buy" />
