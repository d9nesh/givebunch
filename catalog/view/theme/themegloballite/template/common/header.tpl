		...
		<header>
				...
				<div class="container">
					<div class="row">
						...
						<div class="col-sm-4 hidden-xs">
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 logo-inner">
				  		...
				  		<div class="col-sm-8 col-xs-12 hidden-xs">
							...
							<div class="quick-access">
								...
								?>
								<div class="dropdown  my-account my-menu">
											<ul class="megamenu">
												...
												<li>
													<a href="#how-it-works" id="how_it_works_menu_link"><span><strong>How It Works</strong></span></a>
												</li>
												<li>
													<a href="#where-we-deliver" id="where_we_deliver_menu_link"><span><strong>Where We Deliver</strong></span></a>
												</li>
											</ul>
								</div>
					<?php } ?>	
			...
			<div id="header">	
				<div class="container">
					...
					<div class="visible-xs col-xs-4" style="float:right;margin-top:1em;text-align:center;display:inline-block; margin-bottom:20px;">
